...
/*
	integral.hpp description:
		This header file contains a integral-only strict encapsulation type, operators,
...
//	Defines an strict integral-only type.
//
//	Usage example:
...
//	Defines a strict integral-only dynamic type.
//
//	Usage example:
