...
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_string_A, std::string);
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_string_B, std::string);
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_ints_A, std::vector<int>);
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_ints_B, std::vector<int>);
STRICT_TYPES_DEFINE_ALIAS_TYPE(encapsulated_int_ptr, int*);
STRICT_TYPES_DEFINE_ALIAS_TYPE(encapsulated_int, int);
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_struct_alias, struct_with_members);
STRICT_TYPES_DEFINE_ALIAS_TYPE(some_struct_ptr_alias, struct_with_members*);
STRICT_TYPES_DEFINE_DYNAMIC_ALIAS_TYPE(my_dynamic_vector, std::vector);

// some_string_A
void example0(const STRICT_TYPES_NAMESPACE::some_string_A& string) { std::cout << "\nexample0:\n"
																										 << string.value << "\n"; }

// some_string_B
void example0(const STRICT_TYPES_NAMESPACE::some_string_B& string) { std::cout << "\nexample0:\n"
																										 << string.value << "\n"; }

// some_ints_A
void example1(const STRICT_TYPES_NAMESPACE::some_ints_A& ints) {
	std::cout << "\nexample1:\n";
...
// some_ints_B
void example1(const STRICT_TYPES_NAMESPACE::some_ints_B& ints) {
	std::cout << "\nexample1:\n";
...
void example2(const std::vector<int>& ints0, const std::vector<int>& ints1) {
	...
	for (STRICT_TYPES_NAMESPACE::index_t i = 0ULL; i < 5; i++) {
		std::cout << (ints0[i] + ints1[i]) << "\n";
	}
}

// int vectors
void example2(const STRICT_TYPES_NAMESPACE::some_ints_A& ints0, const std::vector<int>& ints1) {
	std::cout << "\nexample2:\n";
...
int main() {
	...
	const STRICT_TYPES_NAMESPACE::some_string_A string0 = "some simple string A";
	const STRICT_TYPES_NAMESPACE::some_string_B string1 = "some simple string B";
	...
	example0(STRICT_TYPES_NAMESPACE::some_string_A(string2));

	// Both some_ints_A and some_ints_B have the same encapsulated std::vector<int> type.
	STRICT_TYPES_NAMESPACE::some_ints_A ints0 = {};
	STRICT_TYPES_NAMESPACE::some_ints_B ints1 = {};
	...
	const STRICT_TYPES_NAMESPACE::some_struct_alias some_struct = struct_with_members(5, 6);
	std::cout << "The sum is: " << some_struct[0] << "\n";

	// An alias type can also encapsulate pointers:
	STRICT_TYPES_NAMESPACE::encapsulated_int_ptr int_ptr = new int[5](1, 2, 3, 4, 5);
	...
	const STRICT_TYPES_NAMESPACE::some_struct_ptr_alias some_struct_ptr = new struct_with_members(5, 6);
	...
	const STRICT_TYPES_NAMESPACE::encapsulated_int encapsulated_int{678};
	const STRICT_TYPES_NAMESPACE::some_ints_A		  encapsulated_ints_vector{5, 6, 7, 8, 5, 4, 3};
	...
	STRICT_TYPES_NAMESPACE::my_dynamic_vector<float> my_floats = {5.0f, 6.4f, 78.9f};
