...
/*
	common.hpp description:
		...
		Example inheritance:
			...
			|                                                                                                                                |
			|   strict_types_base_t ----> strict_types_integral_base_t ---> strict_integral_type<std::size_t> -----> my_size_t               |
			|    				        |                                                                                                         |
			|   					     |----> strict_types_float_base_t ------> strict_float_type<double> -------------> my_double_t             |
			|   					     |                                                                                                         |
			|   					      `---> strict_types_alias_base_t ------> strict_alias_type<std::vector<int>> ---> my_int_vector_alias_t   |
			|                                                                                                                                |
			|--------------------------------------------------------------------------------------------------------------------------------|
*/
